/*! cornerstone-tools - 2.3.9 - 2018-09-24 | (c) 2017 Chris Hafey | https://github.com/cornerstonejs/cornerstoneTools */
...
function onImageRendered(e) {
  ...
  var _loop = function _loop(i) {
    ...
    (0, _drawing.draw)(context, function (context) {
      ...
      (0, _drawing.drawRect)(context, element, data.handles.start, data.handles.end, {
        color: color
      });
...
var _proxyStackSpecificStateManager = __webpack_require__(/*! ./stateManagement/proxyStackSpecificStateManager.js */ "./stateManagement/proxyStackSpecificStateManager.js");

Object.defineProperty(exports, 'addProxyStackStateManager', {
  enumerable: true,
  get: function get() {
    return _proxyStackSpecificStateManager.addProxyStackStateManager;
  }
});
Object.defineProperty(exports, 'newProxyStackSpecificToolStateManager', {
  enumerable: true,
  get: function get() {
    return _proxyStackSpecificStateManager.newProxyStackSpecificToolStateManager;
  }
});
...
var _toolState2 = __webpack_require__(/*! ./stateManagement/proxies/toolState */ "./stateManagement/proxies/toolState.js");

Object.defineProperty(exports, 'SetToolProxyWacher', {
  enumerable: true,
  get: function get() {
    return _toolState2.SetToolProxyWacher;
  }
});
Object.defineProperty(exports, 'GetToolProxyState', {
  enumerable: true,
  get: function get() {
    return _toolState2.GetToolProxyState;
  }
});
Object.defineProperty(exports, 'RestoreToolProxyState', {
  enumerable: true,
  get: function get() {
    return _toolState2.RestoreToolProxyState;
  }
});

var _stackState = __webpack_require__(/*! ./stateManagement/proxies/stackState */ "./stateManagement/proxies/stackState.js");

Object.defineProperty(exports, 'SetStackProxyWacher', {
  enumerable: true,
  get: function get() {
    return _stackState.SetStackProxyWacher;
  }
});
Object.defineProperty(exports, 'GetSatckProxyState', {
  enumerable: true,
  get: function get() {
    return _stackState.GetSatckProxyState;
  }
});
Object.defineProperty(exports, 'RestoreStackProxyState', {
  enumerable: true,
  get: function get() {
    return _stackState.RestoreStackProxyState;
  }
});
...
var _toolState = __webpack_require__(/*! ./proxies/toolState */ "./stateManagement/proxies/toolState.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var toolState = (0, _toolState.RegisterToolProxyState)();
...
/***/ "./stateManagement/proxies/stackState.js":
/*!***********************************************!*\
  !*** ./stateManagement/proxies/stackState.js ***!
  \***********************************************/
/*! no static exports found */
...
var wacher = function wacher(obj) {
  return obj;
};

var SetStackProxyWacher = function SetStackProxyWacher(newWacher) {
  wacher = newWacher;
};

var GetSatckProxyState = function GetSatckProxyState() {
  return proxyState;
};

var RestoreStackProxyState = function RestoreStackProxyState(restoreState) {
  exports.proxyState = proxyState = restoreState;
};

var RegisterStackProxyState = function RegisterStackProxyState() {
  ...
  var handler = {
    ...
    set: function set(obj, prop, value) {
      obj[prop] = value;
      exports.proxyState = proxyState = wacher(proxyState);
      return true;
    }
  };
...
exports.SetStackProxyWacher = SetStackProxyWacher;
exports.RegisterStackProxyState = RegisterStackProxyState;
exports.GetSatckProxyState = GetSatckProxyState;
exports.RestoreStackProxyState = RestoreStackProxyState;
exports.proxyState = proxyState;

/***/ }),

/***/ "./stateManagement/proxies/toolState.js":
/*!**********************************************!*\
  !*** ./stateManagement/proxies/toolState.js ***!
  \**********************************************/
/*! no static exports found */
...
var SetToolProxyWacher = function SetToolProxyWacher(newWacher) {
  wacher = newWacher;
};

var GetToolProxyState = function GetToolProxyState() {
  return proxyState;
};

var RestoreToolProxyState = function RestoreToolProxyState(restoreState) {
  proxyState = restoreState;
};

var RegisterToolProxyState = function RegisterToolProxyState() {
  var handler = {
    get: function get(obj, prop) {
      if (_typeof(obj[prop]) === 'object' && obj[prop] !== null) {
        return new Proxy(obj[prop], handler);
...
exports.SetToolProxyWacher = SetToolProxyWacher;
exports.RegisterToolProxyState = RegisterToolProxyState;
exports.GetToolProxyState = GetToolProxyState;
exports.RestoreToolProxyState = RestoreToolProxyState;

/***/ }),

/***/ "./stateManagement/proxyStackSpecificStateManager.js":
/*!***********************************************************!*\
  !*** ./stateManagement/proxyStackSpecificStateManager.js ***!
  \***********************************************************/
/*! no static exports found */
...
exports.addProxyStackStateManager = exports.newProxyStackSpecificToolStateManager = undefined;
...
var _stackState = __webpack_require__(/*! ./proxies/stackState */ "./stateManagement/proxies/stackState.js");

var state = (0, _stackState.RegisterStackProxyState)();

// This implements an Stack specific tool state management strategy.  This means
// That tool data is shared between all imageIds in a given stack
function newProxyStackSpecificToolStateManager(toolTypes, oldStateManager, viewportDivId) {
  // TODO: why need this code

  var baseState = {};
  var id = viewportDivId;
  ...
  var toolState = new Proxy(baseState, handler);
...
function addProxyStackStateManager(element, otherTools, viewportDivId) {
  ...
  var stackSpecificStateManager = newProxyStackSpecificToolStateManager(stackTools, oldStateManager, viewportDivId);
...
exports.newProxyStackSpecificToolStateManager = newProxyStackSpecificToolStateManager;
exports.addProxyStackStateManager = addProxyStackStateManager;
